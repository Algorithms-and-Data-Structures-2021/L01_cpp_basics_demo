...
int main() {
    ...
    // Например, [5, 2, 7, 1, 9] - массив int-ов.
    ...
    int arr_example_3[] = {};               // вариант 3: с указанием размера, инициализировать все нулями
    arr_example_3[0] = 1;
    ...
    array<int, 5> cpp_arr = {};  // инициализация нулями [0, 0, 0, 0, 0]
